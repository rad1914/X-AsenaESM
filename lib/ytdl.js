...
export const search = async (query, limit = 1) => {
...
export const ytdlget = async (url) => {
 ...
 * @returns
 */
export function formatYtdata(data, options) {
...
export async function ytdlDl(vid, k) {
...
export async function ytv(url, quality = "480p") {
  const data = await ytdlget(url);
...
export const ytsdl = async (query, type = "audio") => {
